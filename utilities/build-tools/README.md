...
3. To Run Curriculum pages:
    ...
    3.2.2 :001 > myMain = Main.new(root: 'path-to/bjc-r-ita/', content: 'cur/..', topic_dir: 'nyc_bjc', [language])
    3.2.2 :002 > myMain.main()

    Example for running english CSP:
    3.2.2 :001 > engCSP = Main.new(root: "C:/Users/I560638/bjc-r-ita/", content: 'programming' topic_dir: "nyc_bjc", "en")
    3.2.2 :002 > engCSP.main()

     Example for running spanish CSP:
    3.2.2 :001 > esCSP = Main.new(root: "C:/Users/I560638/bjc-r-ita/", content: "programming", topic_dir: "nyc_bjc", "es")
